...
func CommandPricedown() *discordgo.ApplicationCommand {
	return &discordgo.ApplicationCommand{
		...
		Description:   "Looks up constituent ingredient prices for the specified crafted item and compares them to the marketboard price. (version 1)",
...
func printPricedown(priceRows []*postgres.AllWorldsPriceRowExpensive) (string, string) {
	itemName := ""
